...
lilap is also a no dependency, or minimal dependencies project, which means there's a lot of wheel re-inventing. It's a one stop solution and does not involve other projects like NGINX, create_ap, hostapd, ifconfig, etc.

## Build
Run `make` and `make clean` to build and clean up lilap respectively
